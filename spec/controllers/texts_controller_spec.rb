  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved text as @text" do
        ...
        post :create, {:text => { "title" => "invalid value" }}, valid_session
        assigns(:text).should be_a_new(Text)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested text" do
        ...
        Text.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => text.to_param, :text => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the text as @text" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Text.any_instance.stub(:save).and_return(false)
        put :update, {:id => text.to_param, :text => { "title" => "invalid value" }}, valid_session
        assigns(:text).should eq(text)
      end
